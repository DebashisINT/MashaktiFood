package com.mashaktifoodfsm.features.logoutsync.presentation
...
import com.mashaktifoodfsm.app.AppDatabase
import com.mashaktifoodfsm.app.NetworkConstant
...
import com.mashaktifoodfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.mashaktifoodfsm.features.billing.api.AddBillingRepoProvider
import com.mashaktifoodfsm.features.billing.model.AddBillingInputParamsModel
...
import com.mashaktifoodfsm.features.dashboard.presentation.ReasonDialog
...
import com.mashaktifoodfsm.features.document.model.AddEditDocumentInputParams
import com.mashaktifoodfsm.features.document.model.DocumentAttachmentModel
...
import com.mashaktifoodfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.mashaktifoodfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.mashaktifoodfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.mashaktifoodfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.mashaktifoodfsm.features.orderhistory.model.*
...
import com.mashaktifoodfsm.features.quotation.model.AddQuotInputModel
import com.mashaktifoodfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.mashaktifoodfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.mashaktifoodfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.mashaktifoodfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.mashaktifoodfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.mashaktifoodfsm.features.timesheet.model.AddTimeSheetInputModel
...
import com.mashaktifoodfsm.MonitorService
import com.mashaktifoodfsm.MySingleton
...
import com.mashaktifoodfsm.features.addshop.presentation.ShopExtraContactReq
...
import com.mashaktifoodfsm.features.login.model.GetConcurrentUserResponse
import com.mashaktifoodfsm.features.login.model.WhatsappApiData
import com.mashaktifoodfsm.features.performance.model.Gps_status_list
import com.mashaktifoodfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.mashaktifoodfsm.features.returnsOrder.ReturnProductList
import com.mashaktifoodfsm.features.returnsOrder.ReturnRequest
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmashaktifoodfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmashaktifoodfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmashaktifoodfsmlogsample/log.zip").path);
